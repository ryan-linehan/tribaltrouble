...
public final strictfp class ARMIEvent implements Serializable {
    ...
    private static final ByteBufferOutputStream static_byte_stream =
    ...
    public static final Object createProxy(
            ARMIEventWriter broker, ARMIArgumentWriter writer, Class armi_interface) {
        ARMIInterfaceMethods armi_interface_methods = new ARMIInterfaceMethods(armi_interface);
        ARMIInvocationHandler handler =
                new ARMIInvocationHandler(broker, writer, armi_interface_methods);
        return Proxy.newProxyInstance(
                ARMIEvent.class.getClassLoader(), new Class[] {armi_interface}, handler);
    }
    ...
    public final void write(ByteBuffer buffer) {
        ...
        if (command_stream != null) buffer.put(command_stream);
    }

    public static final ARMIEvent read(ByteBuffer buffer, short size) {
        ...
        } else command_stream = null;
        return new ARMIEvent(method_id, command_stream);
    }

    private static final byte[] createByteArrayFromCommand(
            ARMIArgumentWriter writer, Class[] method_parameter_types, Object[] args) {
        if (args != null) {
            try {
    ...
    public ARMIEvent(
            ARMIArgumentWriter writer,
            Class[] method_parameter_types,
            byte method_id,
            Object[] args) {
    ...
    private Object[] parseArgs(ARMIArgumentReader reader, Method method)
    ...
    public final void execute(ARMIInterfaceMethods interface_methods, Object instance)
            throws IllegalARMIEventException {
        execute(interface_methods, default_reader, instance);
    }

    public final void execute(
            ARMIInterfaceMethods interface_methods, ARMIArgumentReader reader, Object instance)
            throws IllegalARMIEventException {
        Method method;
        try {
