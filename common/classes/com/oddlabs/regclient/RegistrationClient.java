...
public strictfp class RegistrationClient {
    public static final int KEY_FORMAT_EXCEPTION = 1;
    public static final int LOAD_FAILED_EXCEPTION = 2;
    public static final int HTTP_EXCEPTION = 3;

    public static final int CLIENT_TYPE_OFFLINE = 1;
    public static final int CLIENT_TYPE_ONLINE = 2;
    public static final int CLIENT_TYPE_FOREIGN = 3;
    ...
    public final void setKey(String key) {
        ...
        if (client_type == CLIENT_TYPE_OFFLINE && offlineCheck()) offlineSucceeded();
    }
                ...
                new DeterministicSerializerLoopbackInterface() {
                    ...
                    public final void loadSucceeded(Object obj) {
                        try {
                            ...
                            registration_info =
                                    (RegistrationInfo) signed_registration_key.getObject();
                            if (registration_listener != null)
    ...
    private final void offlineSucceeded() {
        ...
        if (registration_listener != null) registration_listener.registrationCompleted();
    }
    ...
    public final void register(boolean online_registering) {
        if (online_registering
                || client_type == CLIENT_TYPE_ONLINE
                || client_type == CLIENT_TYPE_FOREIGN) {
            parameters.parameters.put("key", potential_key);
            http_client =
                    RegistrationHttpClient.register(
                            task_thread,
                            parameters,
