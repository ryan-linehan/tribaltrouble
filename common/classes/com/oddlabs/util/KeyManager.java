...
public final strictfp class KeyManager {
    ...
    public static final AlgorithmParameterSpec generateParameterSpec()
            throws GeneralSecurityException {
        AlgorithmParameterGenerator paramGen =
                AlgorithmParameterGenerator.getInstance(AGREEMENT_ALGORITHM);
        paramGen.init(KEY_SIZE);
        AlgorithmParameters params = paramGen.generateParameters();
        return params.getParameterSpec(DHParameterSpec.class);
    }

    public static final KeyPair generateInitialKeyPair(AlgorithmParameterSpec param_spec) {
        try {
    ...
    public static final Cipher createCipher(
            int cipher_mode, KeyAgreement key_agreement, PublicKey public_key)
    ...
    public static final PrivateKey readPrivateKey(byte[] encoded_private_key, String algorithm)
    ...
    public static final PublicKey readPublicKey(byte[] encoded_public_key, String algorithm)
            throws InvalidKeySpecException {
        try {
            KeyFactory key_factory = KeyFactory.getInstance(algorithm);
    ...
    public static final KeyAgreement generateAgreement(PrivateKey private_key) {
        try {
    ...
    public static final KeyPair generateKeyPairFromKey(PublicKey public_key)
            throws InvalidKeyException {
        if (!(public_key instanceof DHPublicKey)) throw new InvalidKeyException("Not a public key");
        try {
            KeyPairGenerator key_pair_gen = KeyPairGenerator.getInstance(AGREEMENT_ALGORITHM);
    ...
    public static final Cipher createPasswordCipherFromPassword(char[] password, int mode)
    ...
    public static final Cipher createPasswordCipher(String pass_prompt, int mode)
            throws IOException, GeneralSecurityException {
        return createPasswordCipherFromPassword(readPassword(pass_prompt, System.in), mode);
    }

    /** Reads user password from given input stream. */
    public static final char[] readPassword(String pass_prompt, InputStream in) throws IOException {
        char[] lineBuffer;
        char[] buf;
