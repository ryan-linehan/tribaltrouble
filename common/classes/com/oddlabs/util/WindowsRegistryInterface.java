...
public final strictfp class WindowsRegistryInterface {
    public static final String queryRegistrationKey(String root, String subkey, String value)
        ...
        Method queryRegistrationKey_method =
                org_lwjgl_opengl_WindowsRegistry.getDeclaredMethod(
                        "queryRegistrationKey",
                        new Class[] {int.class, String.class, String.class});
        queryRegistrationKey_method.setAccessible(true);
        //		queryRegistrationKey_method.setAccessible(true);
        Object result =
                queryRegistrationKey_method.invoke(
                        null, new Object[] {new Integer(root_key_enum), subkey, value});
