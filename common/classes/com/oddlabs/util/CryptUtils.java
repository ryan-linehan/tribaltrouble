...
public final strictfp class CryptUtils {
    ...
    private static final String digest(byte[] message_bytes) {
    ...
    private static final String buggyDigest(byte[] message_bytes) {
        byte[] digest_bytes = digest.digest(message_bytes);
    ...
    public static final void setupHttpsConnection(HttpsURLConnection https_connection)
            throws Exception {
        ...
        https_connection.setHostnameVerifier(
