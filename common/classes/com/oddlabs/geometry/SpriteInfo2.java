...
public final strictfp class SpriteInfo2 implements Serializable {
    ...
    public SpriteInfo2(
        ...
        if (texcoords2 != null) this.texcoords2 = new ShortCompressedFloatArray(texcoords2, 2);
        else this.texcoords2 = null;
    ...
    public final float[] getTexCoords2() {
        if (texcoords2 != null) return texcoords2.getFloatArray();
        else return null;
    }
