...
FROM match_valid_key K,
     match_user U
WHERE U.reg_key = K.reg_key
  AND U.banned_until < NOW();

INSERT INTO `settings`
VALUES ('max_profiles', '5');
INSERT INTO `settings`
VALUES ('min_username_length', '2');
INSERT INTO `settings`
VALUES ('max_username_length', '20');
INSERT INTO `settings`
VALUES ('min_password_length', '6');
INSERT INTO `settings`
VALUES ('max_password_length', '20');
INSERT INTO `settings`
VALUES ('allowed_chars', 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789^|_.,:;?+={}[]()/\\&%#!<>*@$');
INSERT INTO `settings`
VALUES ('revision', '1116');
