...
public final strictfp class CopyDist {
    ...
    */
    private static final void pruneDist(File dist, File svndist, SVNWCClient workspace)
    ...
    private static final void copyDist(File dist, File svndist, SVNWCClient workspace)
            throws SVNException, IOException {
    ...
    public static final void main(String[] args) throws SVNException, IOException {
        int arg_index = 0;
        ...
        //		SVNWCClient workspace = SVNWorkspaceManager.createWorkspace("file",
        // svndist_dir.getAbsolutePath());
