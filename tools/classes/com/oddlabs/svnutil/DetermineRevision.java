...
public final strictfp class DetermineRevision implements ISVNStatusHandler {
    ...
    public void handleStatus(SVNStatus status) {
        if (status.getContentsStatus() == SVNStatusType.STATUS_EXTERNAL) return;
    ...
    private DetermineRevision(File workspace_location, File revision_file)
        ...
        if (latest_revision == -1) throw new RuntimeException("Unable to determine revision");
