...
public strictfp class CampaignDialogForm extends Form {
    ...
    public CampaignDialogForm(
            CharSequence header, CharSequence text, Quad image, int align, Runnable runnable) {
    ...
    public CampaignDialogForm(
        ...
        ok_button.addMouseClickListener(
    ...
    private final void buildForm(
            CharSequence header, CharSequence text, Quad image, int align, boolean cancel) {
