...
public strictfp class DemoForm extends Form {
    public DemoForm(GUIRoot gui_root, String header, GUIImage img, String text) {
        ...
        HorizButton buy_button =
                new BuyButton(gui_root, Utils.getBundleString(bundle, "buy_now_caption"), 120);
        addChild(buy_button);
        HorizButton continue_button =
                new HorizButton(Utils.getBundleString(bundle, "continue"), 100);
