...
public final strictfp class GameInfoForm extends Form {
    ...
    public GameInfoForm(Game game) {
        ...
        Label label_headline =
                new Label(
                        Utils.getBundleString(bundle, "game_info"),
        ...
        Label label_size =
                new Label(Utils.getBundleString(bundle, "size"), Skin.getSkin().getEditFont());
        Label label_size_value =
                new Label(
                        ServerMessageBundler.getSizeString(game.getSize()),
        ...
        Label label_terrain_type =
                new Label(
                        ...
                        Skin.getSkin().getEditFont());
        Label label_terrain_type_value =
                new Label(
                        ServerMessageBundler.getTerrainTypeString(game.getTerrainType()),
                        Skin.getSkin().getEditFont());
        ...
        Label label_hills_value =
                new Label(
                        ServerMessageBundler.getHillsString(game.getHills()),
                        Skin.getSkin().getEditFont());
        ...
        Label label_trees_value =
                new Label(
                        ServerMessageBundler.getTreesString(game.getTrees()),
                        Skin.getSkin().getEditFont());
        types.addChild(label_trees);
        values.addChild(label_trees_value);

        Label label_supplies =
                new Label(Utils.getBundleString(bundle, "supplies"), Skin.getSkin().getEditFont());
        Label label_supplies_value =
                new Label(
                        ServerMessageBundler.getSuppliesString(game.getSupplies()),
                        Skin.getSkin().getEditFont());
        types.addChild(label_supplies);
        values.addChild(label_supplies_value);

        Label label_rated =
                new Label(Utils.getBundleString(bundle, "rated"), Skin.getSkin().getEditFont());
        Label label_rated_value =
                new Label(
                        ServerMessageBundler.getRatedString(game.isRated()),
                        Skin.getSkin().getEditFont());
        ...
        Label label_gamespeed_value =
                new Label(
                        ServerMessageBundler.getGamespeedString(game.getGamespeed()),
                        Skin.getSkin().getEditFont());
        types.addChild(label_gamespeed);
        values.addChild(label_gamespeed_value);

        Label label_mapcode =
                new Label(Utils.getBundleString(bundle, "mapcode"), Skin.getSkin().getEditFont());
