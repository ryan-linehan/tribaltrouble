...
public final strictfp class LoginForm extends Form implements RegisterProgressFormListener {
    ...
    public LoginForm(NetworkSelector network, GUIRoot gui_root, MainMenu main_menu) {
        ...
        Label label_headline =
                new Label(
                        Utils.getBundleString(bundle, "login_caption"),
        ...
        Label label_username =
                new Label(Utils.getBundleString(bundle, "username"), Skin.getSkin().getEditFont());
        ...
        ButtonObject button_newuser =
                new HorizButton(Utils.getBundleString(bundle, "new_account"), BUTTON_WIDTH);
        button_newuser.addMouseClickListener(new NewUserListener());
        ButtonObject button_ok =
                new HorizButton(Utils.getBundleString(bundle, "login"), BUTTON_WIDTH);
    ...
    private final void login() {
        ...
        else doLogin(username, password, login, remember_checkbox.isMarked());
    }

    private final void doLogin(
            String username, String password, Login login, boolean remember_login) {
        if (remember_login) {
        ...
        Form connecting_form =
                new MatchmakingConnectingForm(network, gui_root, this, main_menu, login, null);
