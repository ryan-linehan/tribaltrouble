...
public final strictfp class InfoForm extends Form {
    ...
    public InfoForm(Profile profile) {
        ...
        Label label_rating =
                new Label(Utils.getBundleString(bundle, "rating"), Skin.getSkin().getEditFont());
        Label label_rating_value =
                new Label("" + profile.getRating(), Skin.getSkin().getEditFont());
        types.addChild(label_rating);
        values.addChild(label_rating_value);

        Label label_wins =
                new Label(Utils.getBundleString(bundle, "wins"), Skin.getSkin().getEditFont());
        ...
        Label label_losses =
                new Label(Utils.getBundleString(bundle, "losses"), Skin.getSkin().getEditFont());
        Label label_losses_value =
                new Label("" + profile.getLosses(), Skin.getSkin().getEditFont());
        types.addChild(label_losses);
        values.addChild(label_losses_value);

        Label label_invalid =
                new Label(Utils.getBundleString(bundle, "invalid"), Skin.getSkin().getEditFont());
        Label label_invalid_value =
                new Label("" + profile.getInvalid(), Skin.getSkin().getEditFont());
