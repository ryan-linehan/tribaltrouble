...
//		addChild(language_list_box);
        ...
        //---  Player colors panel--- 
        // TODO: Figure out out to place things in a panel on the top left corner
        // TODO: Localization from bundle
        Group group_player_colors = new Group();
        // player_colors.addChild(group_player_colors);
        // Create ui objects
        Label label_player_colors_1 = new Label("Player 1", Skin.getSkin().getEditFont());
        PulldownButton pulldown_player_colors_1 = new PulldownButton(gui_root, new String[]{"Red", "Blue", "Green", "Yellow"}, 0, 150);
        ...
        // TODO: Place button for saving player colors and persist them to settings (for the valid ones. Reset invalid ones)
        // pulldown_player_colors_1.place(label_player_colors_1, BOTTOM_LEFT);
        // Compile ui objects that can be compiled
        group_player_colors.compileCanvas();
        // player_colors.compileCanvas();
        // -- end player colors panel ---
