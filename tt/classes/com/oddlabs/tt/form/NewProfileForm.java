...
public final strictfp class NewProfileForm extends Form {
    ...
    public NewProfileForm(GUIRoot gui_root, Menu main_menu, ProfilesForm profiles_form) {
        ...
        Label label_headline =
                new Label(
                        Utils.getBundleString(bundle, "create_profile_caption"),
                        Skin.getSkin().getHeadlineFont());
        addChild(label_headline);

        // login
        Label label_nick =
                new Label(Utils.getBundleString(bundle, "nick"), Skin.getSkin().getEditFont());
        ...
        ButtonObject button_create =
                new HorizButton(Utils.getBundleString(bundle, "create_profile"), BUTTON_WIDTH_LONG);
    ...
    private final strictfp class CreateProfileListener
            implements MouseClickListener, EnterListener {
