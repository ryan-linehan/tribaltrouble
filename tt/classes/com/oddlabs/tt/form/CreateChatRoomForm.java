...
public final strictfp class CreateChatRoomForm extends Form {
    ...
    private final ResourceBundle bundle =
            ResourceBundle.getBundle(CreateChatRoomForm.class.getName());
    ...
    public CreateChatRoomForm(GUIRoot gui_root, Menu main_menu, SelectGameMenu menu) {
        ...
        Label label_headline =
                new Label(
                        Utils.getBundleString(bundle, "create_room"),
    ...
    private final void create() {
        ...
        if (name.length() < MatchmakingServerInterface.MIN_ROOM_NAME_LENGTH) {
            String min_name_error =
                    Utils.getBundleString(
                            bundle,
                            "min_name_error",
                            new Object[] {
                                new Integer(MatchmakingServerInterface.MIN_ROOM_NAME_LENGTH)
                            });
