...
public final strictfp class LandscapeResources {
    ...
    public LandscapeResources(RenderQueues queues) {
        ...
        SpriteFile fragment1 =
                new SpriteFile(
                        "/geometry/misc/rock_1.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile fragment2 =
                new SpriteFile(
                        "/geometry/misc/rock_2.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile fragment3 =
                new SpriteFile(
                        "/geometry/misc/rock_3.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile fragment4 =
                new SpriteFile(
                        "/geometry/misc/rock_4.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile fragment5 =
                new SpriteFile(
                        "/geometry/misc/rock_5.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
        ...
        SpriteFile native_plant1 =
                new SpriteFile(
                        "/geometry/misc/plant_1.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile native_plant2 =
                new SpriteFile(
                        "/geometry/misc/plant_2.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile native_plant3 =
                new SpriteFile(
                        "/geometry/misc/plant_3.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile native_plant4 =
                new SpriteFile(
                        "/geometry/misc/plant_4.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile viking_plant1 =
                new SpriteFile(
                        "/geometry/misc/viking_plant_1.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile viking_plant2 =
                new SpriteFile(
                        "/geometry/misc/viking_plant_2.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile viking_plant3 =
                new SpriteFile(
                        "/geometry/misc/viking_plant_3.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
                        true,
                        true);
        SpriteFile viking_plant4 =
                new SpriteFile(
                        "/geometry/misc/viking_plant_4.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        false,
                        true,
        ...
        ProgressForm.progress(1f / num_progress);
        SpriteFile sprite_list_chicken =
                new SpriteFile(
                        "/geometry/misc/chicken.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
        ...
        bird_idle_sound[0] =
                (Audio) Resources.findResource(new AudioFile("/sfx/chicken_idle1.ogg"));
        bird_idle_sound[1] =
                (Audio) Resources.findResource(new AudioFile("/sfx/chicken_idle2.ogg"));
        bird_idle_sound[2] =
                (Audio) Resources.findResource(new AudioFile("/sfx/chicken_idle3.ogg"));
        bird_idle_sound[3] =
                (Audio) Resources.findResource(new AudioFile("/sfx/chicken_idle4.ogg"));
    ...
    public static LowDetailModel[] loadTreeLowDetails() {
        LowDetailModel jungle_lowdetail =
                (LowDetailModel)
                        Utils.loadObject(Utils.makeURL("/geometry/misc/tree_low.binlowdetail"));
        LowDetailModel palm_lowdetail =
                (LowDetailModel)
                        Utils.loadObject(Utils.makeURL("/geometry/misc/palm_low.binlowdetail"));
        LowDetailModel oak_lowdetail =
                (LowDetailModel)
                        Utils.loadObject(Utils.makeURL("/geometry/misc/oak_tree_low.binlowdetail"));
        LowDetailModel pine_lowdetail =
                (LowDetailModel)
                        Utils.loadObject(
                                Utils.makeURL("/geometry/misc/pine_tree_low.binlowdetail"));
        return new LowDetailModel[] {
            jungle_lowdetail, palm_lowdetail, oak_lowdetail, pine_lowdetail
        };
    }
