...
public final strictfp class TextureFile extends File {
    ...
    private static URL locate(String location_with_ext) {
        ...
        if (url_classpath != null) return url_classpath;
        try {
            java.io.File file =
                    new java.io.File(com.oddlabs.tt.util.Utils.getInstallDir(), location_with_ext);
    ...
    private static final URL locateDXT(String location) {
        return locate(location + ".dxtn");
    }

    private static final URL locateTexture(String location) {
    ...
    public final boolean equals(Object o) {
        if (!(o instanceof TextureFile)) return false;
        TextureFile other = (TextureFile) o;
        if (internal_format != other.internal_format
                || min_filter != other.min_filter
                || mag_filter != other.mag_filter
                || max_mipmap_level != other.max_mipmap_level
                || wrap_s != other.wrap_s
                || wrap_t != other.wrap_t
                || base_fadeout_level != other.base_fadeout_level
                || fadeout_factor != other.fadeout_factor) return false;
