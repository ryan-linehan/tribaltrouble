...
public final strictfp class NotificationManager {
    ...
    public final void newAttackNotification(
            AnimationManager manager, Selectable target, Player local_player) {
        ...
        addNotification(
                new AttackNotification(local_player, gui_root, target, this, manager),
                attack_notifies);
    }

    public final void newSelectableNotification(
            Selectable s, AnimationManager manager, Player local_player) {
        newNotification(
                manager, local_player, s.getPositionX(), s.getPositionY(), 0f, 1f, 0f, false);
    }
    ...
    private final void newNotification(
        ...
        addNotification(
                new Notification(
                        ...
                        g,
                        b,
                        local_player.getRace().getBuildingNotificationAudio(),
                        show_always,
                        manager),
                notifies);
    }
