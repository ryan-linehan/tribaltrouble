...
public final strictfp class Peer implements PeerHubInterface {
    ...
    private final ARMIInterfaceMethods interface_methods =
            new ARMIInterfaceMethods(PlayerInterface.class);
    ...
    public Peer(
            ...
            int peer_index,
            Player player,
            GameArgumentReader argument_reader,
    ...
    public final void executeEvents(int tick) throws IllegalARMIEventException {
        while (!event_queue.isEmpty()) {
            ...
            if (game_event.tick != tick) return;
    ...
    private static final strictfp class GameEvent {
