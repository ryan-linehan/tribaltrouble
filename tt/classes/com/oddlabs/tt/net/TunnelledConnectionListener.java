...
public final strictfp class TunnelledConnectionListener extends AbstractConnectionListener {
    ...
    public final void requestTunnelledConnection(
            HostSequenceID address,
        ...
        notifyIncomingConnection(
                new TunnelIdentifier(
                        profile,
                        new TunnelAddress(address.getHostID(), inet_address, local_address)));
    }
    ...
    protected final AbstractConnection doAcceptConnection(
