...
public final strictfp class RingEmitter extends LinearEmitter {
    ...
    protected int initParticle(
        ...
        for (int i = 0; i < num_particles; i++) {
            ...
            // in this special case velocity.getZ() is the actual velocity. not the velocity in the
            // z direction
            particle.setVelocity(
                    velocity.getZ() * (float) StrictMath.cos(angle * i),
                    velocity.getZ() * (float) StrictMath.sin(angle * i),
                    0);
