...
public final strictfp class AudioSource extends NativeResource {
    ...
    public AudioSource() {
        ...
        if (Display.isALCreated()) AL10.alGenSources(source_buffer);
    ...
    public final int getRank() {
        if (audio_player == null) return AudioPlayer.AUDIO_RANK_NOT_INITIALIZED;
        return audio_player.getParameters().rank;
    }

    public final void setPlayer(AbstractAudioPlayer audio_player) {
        if (this.audio_player != null) this.audio_player.stop();
