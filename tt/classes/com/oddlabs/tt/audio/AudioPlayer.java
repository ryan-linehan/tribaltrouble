...
public final strictfp class AudioPlayer extends AbstractAudioPlayer {
    ...
    AudioPlayer(AudioSource source, AudioParameters params) {
        ...
        AL10.alSourcei(
                source.getSource(), AL10.AL_LOOPING, params.looping ? AL10.AL_TRUE : AL10.AL_FALSE);

        AL10.alSourcei(
                source.getSource(),
                AL10.AL_SOURCE_RELATIVE,
                params.relative ? AL10.AL_TRUE : AL10.AL_FALSE);

        setGain(params.gain);
        setPos(params.x, params.y, params.z);
        // System.out.println("source.getSource() = " + source.getSource() + " | sound.getBuffer() =
        // " + sound.getBuffer());
