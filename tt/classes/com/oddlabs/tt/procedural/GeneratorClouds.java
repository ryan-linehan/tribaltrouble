...
public final strictfp class GeneratorClouds extends TextureGenerator {
    ...
    public final Texture[] generate() {
        ...
        GLByteImage cloud_images[] =
                new GLByteImage[] {
                    new GLByteImage(clouds1, GL11.GL_LUMINANCE),
                    new GLByteImage(clouds2, GL11.GL_LUMINANCE)
                };
        Texture[] textures = new Texture[cloud_images.length];
        for (int i = 0; i < cloud_images.length; i++) {
            textures[i] =
                    new Texture(
                            cloud_images[i].createMipMaps(),
                            Globals.COMPRESSED_LUMINANCE_FORMAT,
