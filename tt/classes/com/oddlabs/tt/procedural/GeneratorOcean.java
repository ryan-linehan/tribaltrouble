    ...
    public final Texture[] generate() {
        ...
        Channel noise32 =
                perlin32.copy()
                        ...
                        .gamma2()
                        .invert()
                        .perturb(perlin4.copy().rotate(90), 0.05f)
                        .perturb(perlin2, 0.05f);
        Channel noise64 =
                perlin64.copy()
                        .abs()
                        .dynamicRange()
                        .gamma2()
                        .invert()
                        .channelMultiply(perlin32.copy().rotate(90).contrast(2f))
                        .perturb(perlin4.copy().rotate(180), 0.05f)
                        .perturb(perlin2.copy().rotate(90), 0.05f);
        Channel highlight = noise32.channelBrightest(noise64);
        Layer water1 =
                new Layer(
                        new Channel(TEXTURE_SIZE, TEXTURE_SIZE),
        ...
        textures[0] =
                new Texture(
                        new GLImage[] {new GLIntImage(water1)},
                        GL11.GL_RGBA,
                        GL11.GL_LINEAR,
                        GL11.GL_LINEAR,
                        GL11.GL_REPEAT,
        ...
        textures[1] =
                new Texture(
                        new GLImage[] {new GLIntImage(water2)},
                        GL11.GL_RGBA,
                        GL11.GL_LINEAR,
                        GL11.GL_LINEAR,
                        GL11.GL_REPEAT,
