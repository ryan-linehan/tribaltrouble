...
public final strictfp class Ring {
    ...
    public Ring(int width, int height, float[][] gradient_list, int interpolation) {
                            ...
                            case LINEAR:
                                value =
                                        Tools.interpolateLinear(
                                                gradient_list[index - 1][1],
                                                gradient_list[index][1],
                                                (radius - gradient_list[index - 1][0])
                                                        / (gradient_list[index][0]
        ...
        channelfinal.quadJoin(
                channel,
                channel.copy().rotate(270),
                channel.copy().rotate(90),
                channel.copy().rotate(180));
    }
