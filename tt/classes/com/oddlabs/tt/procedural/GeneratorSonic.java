...
public final strictfp class GeneratorSonic extends TextureGenerator {
    ...
    public final Texture[] generate() {
        ...
        sonic_alpha_final.quadJoin(
                sonic_alpha,
                sonic_alpha.copy().rotate(270),
                sonic_alpha.copy().rotate(90),
                sonic_alpha.copy().rotate(180));

        Channel sonic_color = new Channel(TEXTURE_SIZE, TEXTURE_SIZE).fill(.05f);
        // Channel sonic_color = new Channel(TEXTURE_SIZE, TEXTURE_SIZE).fill(.1f); // screenshot
        // fix
