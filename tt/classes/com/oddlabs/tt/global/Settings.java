...
public final strictfp class Settings implements Serializable {
	...
	// network
	public String registration_address = "registration." + Globals.DOMAIN_NAME + ".org";
	public String matchmaking_address = "matchmaking." + Globals.DOMAIN_NAME + ".org";
	public String bugreport_address = "bugreport." + Globals.DOMAIN_NAME + ".org";
	public String router_address = "router." + Globals.DOMAIN_NAME + ".org";
