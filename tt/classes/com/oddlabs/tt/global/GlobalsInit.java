...
public final strictfp class GlobalsInit {
    ...
    private static final int bestTextureSize(int size) {
        ...
        if (size
                        + texture_min * (Globals.TEXTURE_WEIGHT - 1.0f)
                        - texture_max * Globals.TEXTURE_WEIGHT
                > 0) return texture_max;
        else return texture_min;
    }

    private static final void initTextureSize() {
        int tex_pow;
