...
public final strictfp class VikingIsland8 extends Island {
    ...
    protected final void start() {
        ...
        new SceneryModel(
                ...
                0,
                -1,
                local_player.getRace().getRallyPoint());
        ...
        neutrals[0] =
                new Unit(
                        ...
                        325 * 2,
                        null,
                        lost.getRace().getUnitTemplate(Race.UNIT_WARRIOR_RUBBER));
        neutrals[1] =
                new Unit(
                        lost,
                        268 * 2,
                        324 * 2,
                        null,
                        lost.getRace().getUnitTemplate(Race.UNIT_WARRIOR_IRON));
        neutrals[2] =
                new Unit(
                        lost,
                        267 * 2,
                ...
                new Runnable() {
                    public final void run() {
                        ...
                        for (int i = 0; i < neutrals.length; i++) {
                            if (!neutrals[i].isDead()) changeOwner(neutrals[i], local_player);
                        }
                    }
                };
    ...
    private final void setMagicUsedTrigger() {
        ...
        new MagicUsedTrigger(
                getViewer().getLocalPlayer().getChieftain(), 354 * 2, 478 * 2, 15, 0, runnable);
    }
