...
public final strictfp class VikingIsland5 extends Island {
    ...
    public final void init(NetworkSelector network, GUIRoot gui_root) {
        ...
        game_network
                ...
                .getServerInterface()
                .setPlayerSlot(
                        1, PlayerSlot.AI, RacesResources.RACE_VIKINGS, 0, true, PlayerSlot.AI_HARD);
        ...
        game_network
                .getClient()
                .setUnitInfo(2, new UnitInfo(true, false, 1, false, ai_peons, 0, 0, 1));
        game_network
                .getClient()
                .getServerInterface()
                .setPlayerSlot(
                        3, PlayerSlot.AI, RacesResources.RACE_NATIVES, 1, true, PlayerSlot.AI_HARD);
        game_network
                .getClient()
                .setUnitInfo(3, new UnitInfo(true, false, 1, false, ai_peons, 0, 0, 1));
    ...
    protected final void start() {
                ...
                new Runnable() {
                    public final void run() {
                        ...
                        getCampaign()
                                .getState()
                                .setNumRockWarriors(
                                        getCampaign().getState().getNumRockWarriors() + 5);
        ...
        runnable =
                new Runnable() {
                    public final void run() {
                        getCampaign()
                                .defeated(getViewer(), Utils.getBundleString(bundle, "game_over"));
                    }
                };
