...
public final strictfp class NativeIsland0 extends Island {
    ...
    public final void init(NetworkSelector network, GUIRoot gui_root) {
        String[] ai_names =
                new String[] {
                    ...
                    // TODO: X players for all the campaign ones? Maybe unneccessary since no
                    // campaign map has 6 ai
                };
        ...
        game_network
                ...
                .getServerInterface()
                .setPlayerSlot(
                        2, PlayerSlot.AI, RacesResources.RACE_VIKINGS, 1, true, PlayerSlot.AI_HARD);
    ...
    protected final void start() {
        ...
        new Unit(
                ...
                127 * 2,
                null,
                natives.getRace().getUnitTemplate(Race.UNIT_WARRIOR_ROCK));
        new Unit(
                natives,
                149 * 2,
                122 * 2,
        ...
        // Insert viking men
        enemy.setActiveChieftain(
                new Unit(
                        enemy,
                        viking_start_x,
                        viking_start_y,
                        null,
                        enemy.getRace().getUnitTemplate(Race.UNIT_CHIEFTAIN),
        ...
        scenery_models[0] =
                new SceneryModel(
                        ...
                        0,
                        1,
                        getViewer().getWorld().getRacesResources().getTreasures()[0],
                        shadow_diameter,
                        true,
        ...
        scenery_models[1] =
                new SceneryModel(
                        ...
                        -dir,
                        -dir,
                        getViewer().getWorld().getRacesResources().getTreasures()[3],
                        shadow_diameter,
                        true,
                        Utils.getBundleString(bundle, "statue"));
        scenery_models[2] =
                new SceneryModel(
                        ...
                        dir,
                        dir,
                        getViewer().getWorld().getRacesResources().getTreasures()[1],
                        shadow_diameter,
                        true,
                        Utils.getBundleString(bundle, "statue"));
        scenery_models[3] =
        ...
        scenery_models[4] =
                new SceneryModel(
                        ...
                        0,
                        1,
                        getViewer().getWorld().getRacesResources().getTreasures()[4],
                        shadow_diameter,
                        true,
                        Utils.getBundleString(bundle, "statue"));
        scenery_models[5] =
        ...
        scenery_models[6] =
                new SceneryModel(
                        ...
                        dir,
                        -dir,
                        getViewer().getWorld().getRacesResources().getTreasures()[5],
                        shadow_diameter,
                        true,
                        Utils.getBundleString(bundle, "statue"));
                ...
                new Runnable() {
                    public final void run() {
                        ...
                        for (int i = 0; i < viking_units.length; i++) {
                            if (!viking_units[i].isDead()) viking_units[i].removeNow();
                        }
                        // Insert new Vikings
                        ...
                        for (int i = 0; i < num_peons; i++)
                            new Unit(
                                    ...
                                    new_viking_start_y,
                                    null,
                                    enemy.getRace().getUnitTemplate(Race.UNIT_PEON));
                        // Remove natives
                        Selectable[] native_selectables =
                                new Selectable[natives.getUnits().getSet().size()];
                ...
                new Runnable() {
                    public final void run() {
                        ...
                        if (camera instanceof GameCamera) {
                            ...
                            dialog2.run();
                        } else if (camera instanceof JumpCamera
                                || camera instanceof FirstPersonCamera) {
