...
public final strictfp class VikingIsland9 extends Island {
    ...
    protected final void start() {
        ...
        chief_tribe.setActiveChieftain(
                new Unit(
                        chief_tribe,
                        56 * 2,
                        110 * 2,
        ...
        if (enemy.getArmory().getSupplyContainer(IronAxeWeapon.class).getNumSupplies()
                < num_extra_units)
            enemy.getArmory()
                    .getSupplyContainer(IronAxeWeapon.class)
                    .increaseSupply(num_extra_units);
