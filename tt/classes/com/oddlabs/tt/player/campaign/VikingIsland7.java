...
public final strictfp class VikingIsland7 extends Island {
    ...
    public final void init(NetworkSelector network, GUIRoot gui_root) {
        ...
        game_network
                ...
                .getServerInterface()
                .setPlayerSlot(
                        2, PlayerSlot.AI, RacesResources.RACE_NATIVES, 1, true, ai_difficulty);
        game_network
                .getClient()
        ...
        runnable =
                new Runnable() {
                    public final void run() {
                        ...
                        getCampaign()
                                .getState()
                                .setIslandState(9, CampaignState.ISLAND_SEMI_AVAILABLE);
                        getCampaign()
                                .getState()
                                .setIslandState(11, CampaignState.ISLAND_SEMI_AVAILABLE);
