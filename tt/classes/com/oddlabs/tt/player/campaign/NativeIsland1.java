...
public final strictfp class NativeIsland1 extends Island {
    ...
    protected final void start() {
        ...
        float shadow_diameter =
                local_player.getRace().getUnitTemplate(Race.UNIT_PEON).getShadowDiameter();
        SpriteKey sprite_renderer =
                local_player.getRace().getUnitTemplate(Race.UNIT_PEON).getSpriteRenderer();
        ...
        scenery_models[0] =
                new SceneryModel(
                        ...
                        shadow_diameter,
                        true,
                        Utils.getBundleString(bundle, "captive"),
                        Unit.ANIMATION_THROWING,
                        1,
                        .1f);
        scenery_models[1] =
                new SceneryModel(
        ...
        new Unit(
                ...
                98 * 2,
                null,
                guards.getRace().getUnitTemplate(Race.UNIT_WARRIOR_IRON));
        new Unit(
                guards,
                47 * 2,
                92 * 2,
        ...
        final Runnable prize =
                new Runnable() {
                    public final void run() {
                        ...
                        getCampaign()
                                .getState()
                                .setNumPeons(getCampaign().getState().getNumPeons() + NUM_CAPTIVES);
