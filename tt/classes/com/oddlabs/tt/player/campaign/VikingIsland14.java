...
public final strictfp class VikingIsland14 extends Island {
    ...
    public final void init(NetworkSelector network, GUIRoot gui_root) {
        ...
        game_network
                ...
                .getServerInterface()
                .setPlayerSlot(
                        2, PlayerSlot.AI, RacesResources.RACE_NATIVES, 1, true, PlayerSlot.AI_HARD);
        game_network
                .getClient()
                .setUnitInfo(2, new UnitInfo(true, true, 0, false, ai_peons, 0, 0, 0));
        game_network
                .getClient()
                .getServerInterface()
                .setPlayerSlot(
                        3, PlayerSlot.AI, RacesResources.RACE_NATIVES, 1, true, ai_difficulty);
        game_network
                .getClient()
                .setUnitInfo(3, new UnitInfo(true, true, 0, false, ai_peons, 0, 0, 0));
    ...
    protected final void start() {
        ...
        for (int i = 0; i < getCampaign().getState().getNumRubberWarriors(); i++) {
            new Unit(
                    ...
                    start_y,
                    null,
                    local_player.getRace().getUnitTemplate(Race.UNIT_WARRIOR_RUBBER));
        }
