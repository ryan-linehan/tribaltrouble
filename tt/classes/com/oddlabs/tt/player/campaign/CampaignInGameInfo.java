...
final strictfp class CampaignInGameInfo implements InGameInfo {
    ...
    public final void addGUI(WorldViewer viewer, InGameMainMenu menu, Group game_infos) {
        ...
        LabelBox label_objective =
                new LabelBox(
                        Utils.getBundleString(Menu.bundle, "objective"),
                        Skin.getSkin().getEditFont(),
                        LocalInput.getViewWidth() / 2);
        LabelBox label_description =
                new LabelBox(
                        campaign.getCurrentObjective(),
                        Skin.getSkin().getEditFont(),
                        LocalInput.getViewWidth() / 2);
    ...
    public final void addGameOverGUI(
            WorldViewer viewer, final GameStatsDelegate delegate, int header_y, Group group) {
