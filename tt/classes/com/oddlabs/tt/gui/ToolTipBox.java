...
public final strictfp class ToolTipBox extends TextField {
    ...
    public final void render(
            int center_x, int top_y, int clip_left, int clip_right, int clip_bottom, int clip_top) {
        ...
        if (x < 0) x = 0;
        if (x > LocalInput.getViewWidth() - box_width) x = LocalInput.getViewWidth() - box_width;
        if (y < 0) y = 0;
        if (y > LocalInput.getViewWidth() - box_height) y = LocalInput.getViewWidth() - box_height;
