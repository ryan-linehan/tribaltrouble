...
public abstract strictfp class TextField extends GUIObject implements CharSequence {
    ...
    private static final void fillDigitBuffer(long i) {
        ...
        if (sign) digit_buf.insert(0, '-');
    }

    public static final void appendNumberToStringBuffer(long i, StringBuffer buffer) {
        fillDigitBuffer(i);
