...
public final strictfp class InfoPrinter extends GUIObject implements Animated, ChatListener {
    ...
    private static final float[] PRIVATE_COLOR = new float[] {1f, .2f, .4f, 1f};
    private static final float[] TEAM_COLOR = new float[] {.3f, .5f, 1f, 1f};
    ...
    public final void print(String text, float[] color) {
        ...
        if (color != null) label_box.setColor(color);
        addChild(label_box);
