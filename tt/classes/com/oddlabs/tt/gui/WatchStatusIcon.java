...
public final strictfp class WatchStatusIcon extends StatusIcon {
    ...
    protected final void renderGeometry() {
        ...
        if (!building.isDead()
                && !building.getChieftainContainer().isTraining()
                && building.getOwner().getUnitCountContainer().getNumSupplies()
                        < building.getOwner().getWorld().getMaxUnitCount()) {
            // Radeon 9200 problem
            GL11.glEnd();
            ...
            float progress =
                    ((ReproduceUnitContainer) (building.getUnitContainer())).getBuildProgress();
