...
public final strictfp class DebugRender {
    private static final float[][] debug_colors = {
        {7f, 1f, 1f},
        {7f, 1f, 0f},
        {7f, 0f, 1f},
        {.3f, .7f, 0f},
    ...
    private static final float CIRCLE_DELTA = (float) java.lang.StrictMath.PI / 2;
    private static final float ANGLE_DELTA = (float) java.lang.StrictMath.PI / 20;
    ...
    public static final void drawBox(
            float bmin_x,
            float bmax_x,
            float bmin_y,
            float bmax_y,
    ...
    public static final void drawPoint(
    ...
    public static final void drawQuad(
            float x1,
            float y1,
            float x2,
            float y2,
    ...
    public static final void drawCylinder(
            float origin_x,
            float origin_y,
            float origin_z,
            float radius,
            int num_circles /*, float height*/,
            float r,
            float g,
            float b) {
        GL11.glDisable(GL11.GL_TEXTURE_2D);
    ...
    private static final void drawCircle(
            float radius, float origin_x, float origin_y, float origin_z) {
        float x, y;
    ...
    public static final void drawSphere(
            float origin_x,
            float origin_y,
            float origin_z,
            float radius,
