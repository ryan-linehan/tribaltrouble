...
final strictfp class Uploader {
    private static final String STD_OUT_PATTERN = "std\\.out";
    private static final String STD_ERR_PATTERN = "std\\.err";
    private static final String EVENT_LOG_PATTERN = "event\\.log";
    private static final String PID_PATTERN = "hs_err_pid.*\\.log";
    private static final String MAC_PID_PATTERN = "JavaNativeCrash_pid.*\\.log";

    private static final String[] LOG_FILE_PATTERNS = {
        STD_OUT_PATTERN, STD_ERR_PATTERN, EVENT_LOG_PATTERN, PID_PATTERN, MAC_PID_PATTERN
    };

    static void upload(
            URL url, int revision, String email, String comment, File log_dir, Progress progress)
            throws IOException {
        File[] LOG_FILE_DIRS = {
            log_dir,
            log_dir,
